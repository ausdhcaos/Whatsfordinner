                ...
                <div className="topnav__right">
                    {
                        localStorage.getItem('user-info')?
                            <>
                                 <ul>
                                    <li><Link to="" style={{color:'#000000' ,textDecoration: 'none'}}>Menus</Link></li>
                                    <li><Link to="" style={{color:'#000000' ,textDecoration: 'none'}}>Orders</Link></li>
                                    <li><Link to="" style={{ color:'#000000' ,textDecoration: 'none' }}>Paymeent</Link></li>
                                    <li><Link to="" style={{ color:'#000000' ,textDecoration: 'none' }}>Logout</Link></li>
                                    <li><Link to="" style={{color: '#000000', textDecoration: 'none'}}>Resturants Booking</Link></li>
